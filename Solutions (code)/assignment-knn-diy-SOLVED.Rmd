...
str(rawDF)    # See columns and meta data (14 cols, 615 rows)     SWITCH DESCRIPTIONS
head(rawDF)   # See first couple of rows
...
```{r}
cleanDF_random$Category <- fct_collapse(cleanDF_random$Category, Blood_Donor = "0=Blood Donor", Suspected_Blood_Donor = "0s=suspect Blood Donor", Hepatits = c("1=Hepatitis", "2=Fibrosis", "3=Cirrhosis")) ###"Suspect_Blood_Donor" SWITCH WITH "Hepatitis"
