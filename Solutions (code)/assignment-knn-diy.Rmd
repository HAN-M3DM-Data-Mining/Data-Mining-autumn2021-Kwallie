...
str(rawDF) # See first couple of rows
head(rawDF) # See columns and meta data (14 cols, 615 rows)
...
```{r}
cleanDF_random$Category <- fct_collapse(cleanDF_random$Category, Blood_Donor = "0=Blood Donor", Hepatitis = "0s=suspect Blood Donor", Suspected_Blood_Donor = c("1=Hepatitis", "2=Fibrosis", "3=Cirrhosis"))
